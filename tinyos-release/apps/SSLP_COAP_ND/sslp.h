...
//Service Acknowledgeme	nt Messages(SACK) are received in response to the SREG messages
typedef struct {
	char service[16];
	char scope[16];
	char url[48];	
...
#define MAX_SERVICE_ADVERTISE	6	//Maximum services the SA can advertise
