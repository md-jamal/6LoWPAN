...
public class Translation
{
	...
	public static void main(String args[])
	{
		...
		//	InetAddress MULTICAST_IP= InetAddress.getByName("239.255.255.253");
			...
			InetAddress SVRLOC_DA= InetAddress.getByName("FF02::123"); 
			...
			Thread SLP_Thread = new Thread(new SLP_Listener(SLP_Socket));
			
			Thread SSLP_Thread = new Thread(new SSLP_Listener(SSLP_Socket));
...
class SLP_Listener implements Runnable
{
	...
	public SLP_Listener(MulticastSocket sock)
	{
		this.sock = sock;
	}
	@Override
	...
	case SLPMessage.SERVICE_REQUEST:
		...
		try {
			InetAddress ip = InetAddress.getByName("FEC0::3");
